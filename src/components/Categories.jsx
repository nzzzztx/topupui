export default function Categories({
    ...
    return (
        <div className="px-4 md:px-16 mt-6 flex flex-col md:flex-row md:items-center md:justify-between border-b border-[#1f2937] pb-4 gap-6">
            ...
            <div className="relative w-full md:w-72">
                ...
                <input
                    ...
                    type="text"
                    placeholder="Cari..."
                    className="w-full bg-[#111827] border border-[#1f2937] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 px-4 py-2.5 pl-10 text-sm rounded-xl outline-none transition placeholder-gray-500"
                />
