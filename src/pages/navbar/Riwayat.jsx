...
export default function Riwayat() {
    ...
    const loadData = () => {
        ...
        if (user) {
            const allTransactions = getSecure("xml_transactions") || []
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="relative bg-[#111827] w-[95%] max-w-xl rounded-2xl border border-blue-500/20 p-8 shadow-2xl">
                            ...
                            <div className="space-y-4 text-sm">
                                ...
                                <DetailRow label="Produk" value={selected.product?.name || "Top Up Saldo"} />
                                <DetailRow
                                    label="Total"
                                    value={`Rp ${(selected.totalPrice || 0).toLocaleString("id-ID")}`}
                                />
                                <DetailRow
                                    label="Payment"
                                    value={selected.selectedPayment || selected.method || "SALDO"}
                                />
                                <DetailRow
                                    label="Status"
                                    value={
